...
public class Main {
    ...
    public static final String TASK_DEF_NAME = "example-wfrun-json-path-filter-quotes";
    public static final String WF_NAME = "example-wfrun-json-path-filter";
    public static final String VARIABLE_QUOTE = "quote";

    public static Workflow getWorkflow() {
        return Workflow.newWorkflow(
                WF_NAME, wf -> wf.execute(TASK_DEF_NAME, wf.declareStr(VARIABLE_QUOTE)));
    }
