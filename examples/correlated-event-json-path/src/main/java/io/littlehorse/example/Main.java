...
public class Main {
    ...
    public static final String TASK_DEF_NAME = "example-correlated-event-json-path-character-name";
    public static final String WF_NAME = "example-correlated-event-json-path";
    public static final String EXTERNAL_EVENT_NAME = "example-correlated-event-json-path";
