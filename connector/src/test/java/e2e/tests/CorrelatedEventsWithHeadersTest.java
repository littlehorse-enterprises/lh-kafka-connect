...
public class CorrelatedEventsWithHeadersTest extends E2ETest {

    public static final String WORKFLOW_NAME = "correlated-events-with-headers";
    private static final String TOPIC_NAME = "correlated-events-with-headers";
    public static final String EXTERNAL_EVENT = "correlated-events-with-headers";
    public static final String CONNECTOR_NAME = "correlated-events-with-headers";
    ...
    public void shouldSendCorrelatedEventsAfterProducing() {
        ...
        String correlationId = "MyUniqueID." + UUID.randomUUID();
