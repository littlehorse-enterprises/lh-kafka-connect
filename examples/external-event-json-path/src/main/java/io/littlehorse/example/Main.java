...
public class Main {
    ...
    public static final String TASK_DEF_NAME = "example-external-event-json-path-greet";
    public static final String WF_NAME = "example-external-event-json-path";
    public static final String EXTERNAL_EVENT_NAME = "example-external-event-json-path";
