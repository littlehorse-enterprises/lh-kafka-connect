...
public class Main {
    ...
    public static final String TASK_DEF_NAME = "example-wfrun-json-path-value-id-greet";
    public static final String WF_NAME = "example-wfrun-json-path-value-id";
    ...
    public static class GreetingsWorker {
        ...
        public String greeting(String customer, WorkerContext context) {
            String message = "Hello there! " + customer + ". My wfRunId is: "
