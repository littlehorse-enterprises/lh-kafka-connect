...
public class Main {
    ...
    public static final String TASK_DEF_NAME = "example-wfrun-json-greet";
    public static final String WF_NAME = "example-wfrun-json";
    public static final String VARIABLE_VEHICLE = "vehicle";
    ...
    public static Workflow getWorkflow() {
        return Workflow.newWorkflow(
                ...
                wf -> wf.execute(
                        TASK_DEF_NAME,
                        wf.declareStr(VARIABLE_NAME),
                        wf.declareJsonObj(VARIABLE_VEHICLE)));
    }
