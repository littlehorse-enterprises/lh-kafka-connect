...
public class Main {
    ...
    public static final String TASK_DEF_NAME = "example-correlated-event-simple-character-name";
    public static final String WF_NAME = "example-correlated-event-simple";
    public static final String EXTERNAL_EVENT_NAME = "example-correlated-event-simple";
