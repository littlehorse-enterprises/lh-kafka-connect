...
public class KafkaConnectContainer
    extends GenericContainer<KafkaConnectContainer> {

    private static final DockerImageName DEFAULT_IMAGE_NAME =
        DockerImageName.parse("confluentinc/cp-kafka-connect");
    private static final int DEFAULT_PORT = 8083;
    private static final String CONNECT_BOOTSTRAP_SERVERS =
        "CONNECT_BOOTSTRAP_SERVERS";
    private static final String CONNECT_GROUP_ID = "CONNECT_GROUP_ID";
    private static final String CONNECT_CONFIG_STORAGE_TOPIC =
        "CONNECT_CONFIG_STORAGE_TOPIC";
    private static final String CONNECT_OFFSET_STORAGE_TOPIC =
        "CONNECT_OFFSET_STORAGE_TOPIC";
    private static final String CONNECT_STATUS_STORAGE_TOPIC =
        "CONNECT_STATUS_STORAGE_TOPIC";
    private static final String CONNECT_KEY_CONVERTER = "CONNECT_KEY_CONVERTER";
    private static final String CONNECT_VALUE_CONVERTER =
    ...
    public KafkaConnectContainer(
        ...
        this.withExposedPorts(DEFAULT_PORT)
            ...
            .waitingFor(
                Wait.forLogMessage(".*\"GET /connectors HTTP/1.1\" 200.*", 1)
            );
    }
